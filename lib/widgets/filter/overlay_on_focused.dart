...
/// CreateDate: 2025/7/16 16:36
/// Author: Lee
/// Description:

typedef FocusableViewBuilder =
    Widget Function(BuildContext context, OverlayFocusNode focusNode);
...
class _OverlayOnFocusedState extends State<OverlayOnFocused> {
  ...
  void _removeOverlayWhenScopeNotFocus() {
    if (_scopeNode!.focusedChild != null || _scopeNode!.hasFocus) return;
            ...
            child: CallbackShortcuts(
              bindings: {
                const SingleActivator(LogicalKeyboardKey.escape): () {
                  final firstFocused = _scopeNode?.children.firstWhere(
                    (e) => e.hasFocus,
                  );
...
class OverlayFocusNode extends FocusNode {
  ...
  void dismissOverlay() => _dismissOverlay!.call();
}
